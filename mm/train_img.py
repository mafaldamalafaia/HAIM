...
for j in range(len(lrs)):
    ...
    for k in range(len(wds)):
        ...
        for i in range(5): # 5-fold CV
            ...
            model = img_net()
            model.to(device)
            # freeze ft engineering block
            for param in model.dense_fts.parameters():
...
save_dir = '/export/scratch1/home/malafaia/HAIM/mm/saved_models/img_'
# save each model
